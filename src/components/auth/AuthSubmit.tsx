...
export default function AuthSubmit({ loading, ...props }: PropTypes) {
  if (loading)
    return (
      <div className="flex h-10 flex-1 items-start justify-center">
        <div className="flex w-full justify-center rounded-md bg-blue-400 px-4 py-1 font-medium text-white">
  ...
  return (
    <div className="flex h-10 flex-1 items-start justify-center">
      <button
        type="submit"
        className="w-full rounded-md bg-blue-600 px-4 py-1 font-medium text-white hover:bg-blue-500"
        {...props}
      >
        Submit
      </button>
